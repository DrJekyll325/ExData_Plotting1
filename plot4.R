plot4 <- function()
{
	...
	##	Create the frame for the four plots
	par(mfrow=c(2,2))
	...
	legend('topright', lty = 1, c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), cex = 0.5)
	...
	##	Add the line for Global Reactive Power over the Date/Time range
